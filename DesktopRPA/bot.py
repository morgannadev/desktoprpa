...
def main():
    ...
    # Neste momento, estamos no campo Cod Receita e vamos preencher com o valor
    bot.paste("5629")

    # Precisamos pressionar tab para avançar
    bot.tab()

    # às vezes essa parte dá erro, escolhi deixar um tempo para poder trocar a tela
    bot.wait(1000)
